...
\itz{
\item{We, computing keyswitch matrices, know the matrices of transformations}
\vspace{.15in}
\item{The cloud, with the data, does not learn our function.}
}
\vspace{.07in}
\begin{figure}[ht]
\centering
...
\item{Server cannot learn our queries, or even distinguish between each type.}
}
\end{frame}
...
\itz{
\item{In our demo, the scheme is slow due mainly to our lack of optimization.}
\item{No overhead in addition, and multiplicative overhead in linear transformations and inner products equal to the number of bits involved.
	\itz{
